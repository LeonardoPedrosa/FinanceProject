...
namespace FinanceApp.Api.Services.Intefaces
{
    public interface ICategoryService
    {
        ...
        Task<CategoryStatusDto> GetCategoryStatusAsync(Guid userId, Guid categoryId, int year, int month);
        ...
        Task<CategoryResponseDto> UpdateCategoryAsync(Guid userId, Guid categoryId, UpdateCategoryDto dto, int year, int month);
    }
}