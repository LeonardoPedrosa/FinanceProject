...
namespace FinanceApp.Api.Data.Migrations
{
    ...
    [Migration("20260308210328_20260308000000_AddUserConnectionsAndIsPrivate")]
    partial class _20260308000000_AddUserConnectionsAndIsPrivate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApp.Api.Models.UserConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SharerId", "ReceiverId")
                        .IsUnique();
            ...
            modelBuilder.Entity("FinanceApp.Api.Models.UserConnection", b =>
                {
                    b.HasOne("FinanceApp.Api.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinanceApp.Api.Models.User", "Sharer")
                        .WithMany()
